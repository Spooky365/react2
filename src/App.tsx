...
const APP_VERSION = "v1.1.5"; // Version erhöht

// +++ NEUE KOMPONENTE FÜR DAS IMPRESSUM +++
  ...
  return (
    <main className="text-gray-300 bg-slate-900/50">
      <div className="max-w-4xl mx-auto py-20 px-4 sm:px-6 lg:px-8">
        <button
          onClick={onBack}
          className="inline-flex items-center mb-12 text-cyan-400 hover:text-cyan-300 transition-colors group"
        >
        ...
        <div className="bg-slate-800/80 backdrop-blur-sm border border-slate-700/50 rounded-xl p-8 md:p-12 space-y-8">
          ...
          <div>
            ...
            <p><strong>E-Mail:</strong> kontakt@falksolutions.net</p>
          </div>
          ...
          <div>
            ...
            <p className="leading-relaxed">
              Als US-amerikanisches Unternehmen ohne Niederlassung in der Europäischen Union unterliegen unsere Dienstleistungen nicht der deutschen Umsatzsteuer. Bei Geschäften mit anderen Unternehmen in der EU findet ggf. das Reverse-Charge-Verfahren Anwendung.
            </p>
          </div>
          ...
          <div>
            <h2 className="text-3xl font-bold text-white mb-6">Haftungsausschluss (Disclaimer)</h2>
...
function App() {
  ...
  const [view, setView] = useState('main'); // 'main' or 'impressum'
  ...
  const scrollToSection = (sectionId) => {
    // If we are not on the main view, switch to it first
    if (view !== 'main') {
      setView('main');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white">
      <nav className="fixed top-0 left-0 right-0 bg-slate-900/95 backdrop-blur-sm border-b border-slate-700/50 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-12">
            <button onClick={showMainPage} className="flex items-center space-x-2 cursor-pointer">
      ...
      {view === 'impressum' && <ImpressumPage onBack={showMainPage} />}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 text-center">
              <div className="text-gray-400 text-sm">
                <span>© 2025 Falk Solutions, LLC. Alle Rechte vorbehalten.</span>
                <span className="mx-2 text-gray-600">|</span>
                <button onClick={showImpressum} className="hover:text-white transition-colors">
                  Impressum
                </button>
              </div>
